...
public class CodeletsProfilerTest {
    ...
    public void testCodeletsProfiler() throws InterruptedException {
         ...
         c2.addBroadcast(m5);
         m.insertCodelet(c2);
         CodeletsProfiler codeletProfiler = new CodeletsProfiler(m, "D:\\Projeto Ericsson-Unicamp\\codelet_profiler_test\\", "codeletProfilerTest.txt", 1);
    ...
    public void testCodeletsProfilerWithInterrupt() throws InterruptedException {
         ...
         c2.addBroadcast(m5);
         m.insertCodelet(c2);
         CodeletsProfiler codeletProfiler = new CodeletsProfiler(m, "D:\\Projeto Ericsson-Unicamp\\codelet_profiler_test\\", "codeletProfilerTestWithInterrupt.txt", 1);
         codeletProfiler.start();
         Thread.sleep(10);
         System.out.println("******** isRunning() "+ codeletProfiler.isRunning());
