...
```
	dependencies {
            ...
            implementation 'com.github.CST-Group:cst:1.6.2'
	}
```
...
![CST Core](https://faculty.dca.fee.unicamp.br/gudwin/sites/faculty.dca.fee.unicamp.br.gudwin/files/cst/CogSys-Core.png)
...
![CST Overall Architecture](https://faculty.dca.fee.unicamp.br/gudwin/sites/faculty.dca.fee.unicamp.br.gudwin/files/cst/CogSys-Codelets.png)
